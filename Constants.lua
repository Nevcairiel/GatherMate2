...
local node_textures = {
	["Fishing"] = {
		...
		[149] = icon.path.."Fish\\salmon.tga",
		[150] = icon.path.."Fish\\goby.tga",
		[151] = icon.path.."Fish\\mudfish.tga",
		[152] = icon.path.."Fish\\suckerfish.tga",
		[153] = icon.path.."Fish\\herring.tga",
		[154] = icon.path.."Fish\\sagefish.tga",
		[155] = icon.path.."Gas\\cinder.tga",
		[156] = icon.path.."Fish\\debris.tga",
	},
	["Mining"] = {
